...
class ChatbotPipeline:
    ...
    async def main_process(self, user_input: str, user_id: str, firm_id: str, role_id: str) -> dict:
        """
        ...
        try:
            ...
            logger.info("Processing query: '%s' for Firm: %s, Role: %s", user_input, firm_id, role_id)
    ...
    async def main_chatbot(
        ...
        # Process query
        response = await self.main_process(translated_input, user_id, firm_id, role_id)
    ...
    async def generate_content_stream(
        ...
        try:
            ...
            response_data = await self.main_process(translated_input, user_id, firm_id, role_id)
