...
from ui_security import SecurityHeadersMiddleware, RestrictSwaggerMiddleware, BlockReDocMiddleware
...
async def chat(request: Request):  # Missing 'request' parameter
